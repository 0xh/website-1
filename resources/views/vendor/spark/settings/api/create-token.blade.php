                    ...
                    <div class="form-group" :class="{'has-error': form.errors.has('abilities')}" v-if="availableAbilities.length > 0">
                        ...
                        <div class="col-md-6">
                            <div v-for="ability in availableAbilities">
                                <div class="checkbox">
                                    <label>
                                        <input type="checkbox" @click="toggleAbility(ability.value)" :checked="abilityIsAssigned(ability.value)"> @{{ ability.name }}
                                    </label>
                                </div>
                            </div>
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <div class="alert alert-warning">
                            ...
                            be displayed, so be sure not to lose it!</strong> You may revoke the token at any time from your API settings.
                        </div>
                        <textarea id="api-token" class="form-control resize_vertical" @click="selectToken" rows="5">@{{ showingToken }}</textarea>
                    </div>
                    <!-- Modal Actions -->
