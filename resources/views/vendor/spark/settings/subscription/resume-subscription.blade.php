    ...
    <div class="panel panel-success">
        ...
        <div class="panel-body table-responsive">
            ...
            <div class="p-b-lg">
                ...
                <strong>@{{ activeSubscription.ends_at | date }}</strong>. You may resume your subscription at no extra cost until the end of the billing period.
            </div>
            <!-- European VAT Notice -->
                ...
                <table class="table table-borderless m-b-none">
                    ...
                    <tbody>
                        <tr v-for="plan in paidPlansForActiveInterval">
                            ...
                            <!-- Plan Select Button -->
                            <td class="text-right">
                                <button class="btn btn-plan" v-bind:class="{'btn-warning-outline': ! isActivePlan(plan), 'btn-warning': isActivePlan(plan)}" @click="updateSubscription(plan)" :disabled="selectingPlan">
