<spark-subscribe-stripe :user="user" :team="team" :plans="plans" :billable-type="billableType" inline-template>
    <div>
        <!-- Common Subscribe Form Contents -->
        @include('spark::settings.subscription.subscribe-common')
        <!-- Billing Information -->
        <div class="panel panel-success" v-show="selectedPlan">
            ...
            <div class="panel-body">
                ...
                <form class="form-horizontal" role="form">
                    ...
                    <h2><i class="fa fa-btn fa-map-marker"></i>Billing Address</h2> @include('spark::settings.subscription.subscribe-address')
