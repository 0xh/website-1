            ...
            <table class="table table-borderless m-b-none">
                ...
                <tbody>
                    <tr v-for="plan in paidPlansForActiveInterval">
                        ...
                        <!-- Plan Select Button -->
                        <td class="text-right">
                            <button class="btn btn-primary-outline btn-plan" v-if="selectedPlan !== plan" @click="selectPlan(plan)" :disabled="form.busy">
                                Select
                            </button>
                            <button class="btn btn-primary btn-plan" v-if="selectedPlan === plan" disabled>
