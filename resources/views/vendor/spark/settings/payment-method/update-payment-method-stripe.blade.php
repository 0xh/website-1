    ...
    <div class="panel panel-info">
        ...
        <div class="panel-body">
            ...
            <form class="form-horizontal" role="form">
                ...
                <h2><i class="fa fa-btn fa-map-marker"></i>Billing Address</h2> @include('spark::settings.payment-method.update-payment-method-address')
                ...
                <div class="form-group" :class="{'has-error': cardForm.errors.has('number')}">
                    ...
                    <div class="col-md-6">
                        <input type="text" class="form-control" data-stripe="number" :placeholder="placeholder" v-model="cardForm.number">
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-6">
                        <div class="row">
                            <!-- Month -->
                            <div class="col-xs-6">
                                <input type="text" class="form-control" placeholder="MM" maxlength="2" data-stripe="exp-month" v-model="cardForm.month">
                            </div>
                            <!-- Year -->
                            <div class="col-xs-6">
                                <input type="text" class="form-control" placeholder="YYYY" maxlength="4" data-stripe="exp-year" v-model="cardForm.year">
                            </div>
                        </div>
                    </div>
                </div>
