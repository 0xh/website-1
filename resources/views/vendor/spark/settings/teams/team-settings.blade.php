@extends('spark::layouts.app') @section("title") Team Settings @endsection @section('breadcrumb')
<h1>Team Settings</h1>
<ol class="breadcrumb">
    <li>
        <a href="/">
    ...
    <li>
        <a href="/settings#/teams">Team Settings</a>
    </li>
</ol>
@endsection @section('scripts') @if (Spark::billsUsingStripe())
            ...
            <div class="col-md-12">
                <div class="tab-content">
                    ...
                    <div role="tabpanel" class="tab-pane" id="membership">
                        ...
                        <!-- Billing Tab Panes -->
                        @if (Spark::canBillTeams() && Auth::user()->ownsTeam($team)) @if (Spark::hasPaidTeamPlans())
                        <!-- Subscription -->
