        ...
        <ul class="navigation">
            ...
            <li class="menu-dropdown">
                ...
                <ul>
                    ...
                    @if (Spark::usesTeams())
                    <li>
                        <a href="/settings#/{{str_plural(Spark::teamString())}}" aria-controls="teams">
            ...
            <li class="menu-dropdown"><a href="#"><i class="ti-user"></i><span> {{ ucfirst(str_plural(Spark::teamString())) }} Settings</span><span class="fa arrow"></span></a>
                <ul>
