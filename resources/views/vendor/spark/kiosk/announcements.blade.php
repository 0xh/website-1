            ...
            <div class="panel-body">
                ...
                <form class="form-horizontal" role="form">
                    ...
                    <div class="form-group" :class="{'has-error': createForm.errors.has('body')}">
                        ...
                        <div class="col-md-6">
                            <textarea class="form-control resize_vertical" name="announcement" rows="7" v-model="createForm.body" style="font-family: monospace;">
                            </textarea>
                    ...
                    <div class="form-group">
                        <div class="col-md-offset-4 col-md-6">
                            <button type="submit" class="btn btn-primary" @click.prevent="create" :disabled="createForm.busy">
                                Create
                            </button>
                        </div>
                    </div>
