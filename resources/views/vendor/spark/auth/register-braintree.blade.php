@extends('spark::layouts.layout_2') @section("title") Register @endsection @section("styles")
<link rel="stylesheet" type="text/css" href="/css/login.css"> @endsection @section('scripts')
