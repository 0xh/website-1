<form class="form-horizontal" role="form">
    ...
    <div class="form-group" :class="{'has-error': registerForm.errors.has('team')}" v-if=" ! invitation">
        <div class="col-md-12">
            <input type="name" class="form-control" name="team" v-model="registerForm.team" autofocus placeholder="{{ ucfirst(Spark::teamString()) }} Name">
    ...
    <div class="form-group" :class="{'has-error': registerForm.errors.has('name')}">
        <div class="col-md-12">
            <input type="name" class="form-control" name="name" v-model="registerForm.name" autofocus placeholder="Name">
