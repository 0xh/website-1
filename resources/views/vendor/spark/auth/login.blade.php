@extends('spark::layouts.layout_2') @section("styles")
<link rel="stylesheet" type="text/css" href="/css/login.css"> @endsection @section("title") Login @endsection @section('content')
<div class="container">
    <div class="row">
